...
public interface Cell extends Cloneable {
     ...
     * 
     * @param row
     *            the integer value of the row. 0 based
     */
     ...
     * 
     * @param column
     *            the integer value of the column. 0 based
     */
     ...
     * 
     * @param function
     *            the {@link Function} function to use for this cell
     */
    ...
    /**
     * Gets the {@link FontStyle} style of the cell
     * 
     * @return the {@link FontStyle} style
     */
    public FontStyle getStyle();

    /**
     * Sets the {@link FontStyle} style of the cell
     * 
     * @param style
     *            the {@link FontStyle} style to set for the cell
     */
